...
class GameProvider extends Component {
  ...
  skipImageAndReload() {
    ...
    const skippedGame = new Game(
      this.state.img.caption,
      this.state.img.img_src,
      'SKIPPED',
      false,
      true,
    );
    ...
    return (
      <GameContext.Provider
        value={{
          ...
          setToPregameMode: () =>
            this.setState({ gameMode: this.state.PREGAME }),
          setToLiveMode: () =>
            this.setState({ gameMode: this.state.gameModes.LIVEGAME }),
          setToPostgameMode: () =>
            this.setState({ gameMode: this.state.gameModes.POSTGAME }),
          img: this.state.img,
